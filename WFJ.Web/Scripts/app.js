...
////////////////////////////// TEMPLATE Color /////////////////////////
    $(".gradient-img-block").on('click', function () {
        ...
        var imageUrl = "~/Images/" + $(this).data('img');
